...
# SOURCE/CREDITS - https://github.com/SrGrace/InterviewBit/blob/master/Binary%20Search/MedianOfArray.cpp

# Beautiful Approach
 

# Considering odd-length and even-length arrays in same case
# Concept of Median in a sorted array.
...
double Solution::findMedianSortedArrays(const vector<int> &A, const vector<int> &B) 
{
    ...
    while (l<=r)
    {
        int mid1 = l + (r-l)/2;//cut 1
        int mid2 = m+n-mid1; //cut 2 will be m+n-cut 1
        ...
        // we only need to check condition if L1 <= R2 or not and L2 <= R1 or not. If yes, no problem. If no, change l and r respectively
